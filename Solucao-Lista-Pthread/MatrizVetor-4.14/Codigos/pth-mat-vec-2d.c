 ...
 *     3.  We use a 2-dimensional array for A 
...
/* Parallel function */
void *Pth_mat_vect_WITH_FALSE_SHARING(void* rank);
...
#  endif
   ...
   for (thread = 0; thread < thread_count; thread++)
      pthread_create(&thread_handles[thread], NULL,
         Pth_mat_vect_WITH_FALSE_SHARING, (void*) thread);
...
#  endif
   ...
   //printf("Thread %ld > Elapsed time = %.10lf seconds\n", 
