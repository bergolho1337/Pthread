...
void        Get_input(const char *argv[], int* inserts_in_main_p);
...
int main(int argc, char* argv[]) {
   ...
   Get_input(argv,&inserts_in_main);
...
void Usage(char* prog_name) {
   fprintf(stderr, "-------------------------------------------------------------------------------------------------------------\n");
   fprintf(stderr, "Usage:> %s <thread_count> <num_keys_inserted> <total_ops> <search_percent> <insert_percent>\n", prog_name);
   fprintf(stderr, "-------------------------------------------------------------------------------------------------------------\n");
   fprintf(stderr, "<thread_count> = Number of threads\n");
   fprintf(stderr, "<num_keys_inserted> = Number of keys that will be inserted in the main thread\n");
   fprintf(stderr, "<total_ops> = Total number of operations that should be executed\n");
   fprintf(stderr, "<search_percent> = Percent of ops that should be searches (between 0 and 1)\n");
   fprintf(stderr, "<insert_percent> = Percent of ops that should be inserts (between 0 and 1)\n");
   fprintf(stderr, "-------------------------------------------------------------------------------------------------------------\n");
   exit(0);
}  /* Usage */
