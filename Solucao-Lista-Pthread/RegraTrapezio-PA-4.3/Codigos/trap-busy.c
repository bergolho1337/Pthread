// ------------------------------------------------------------
// This version solves the trapezium rule using Pthread
// The critical section is implemented using a mutex
// ------------------------------------------------------------
...
void* Trap (void* rank) 
{
   ...
   long i, local_n, remain;
   double local_a, local_b;
   double x, local_int;

   local_n = n / thread_count;
   remain = n % thread_count;
   ...
   {
       local_a = a + my_rank*h*local_n + remain*h;
       local_b = local_a + local_n*h;
   }
